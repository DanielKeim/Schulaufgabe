...
class CentralWidget(QWidget):
    def __init__(self, parent=None):
        ...
        layout = QGridLayout()
# wichtig dazu schreiben

        self.pizza_size = QLabel("Pizzagröße:")
# Qlabel das was da steht "Pizzagröße"
        layout.addWidget(self.pizza_size, 1, 1)


        self.pizza_small = QRadioButton("Kleine Pizza")
# QRadioButton ist ein button zum drücken man kann nur einen andrücken
...
# QCheckBox mehrerer auswahl möglichkeiten
...
# nach card holder syntax damit es nach rechts geschoben wird
...
# 9 heisst von 0 bis 9      x statt 9 heisst alle zahlen
# ;x am ende heist mehr kannn man nicht eingeben
...
# wichtig muss immer unten stehen
